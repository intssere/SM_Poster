  ...
  return <div className="app-shell">
    <aside className="sidebar">
      <div className="brand-mark">DS</div>
       <div><h1>Diamond Shelf</h1><p>Social Studio</p></div><button onClick={() => selectPage('publications')} className={activePage === 'publications' ? 'active' : ''}>Publications / Scheduler</button>
