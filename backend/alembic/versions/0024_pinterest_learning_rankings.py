...
from app.db.migration_adoption import (
    ...
    reconcile_development_drift_at_0024,
    verify_development_0023_analytics_rebuild,
)
...
def _create_canonical_0023_analytics_tables():
    op.create_table(
...
def upgrade():
    bind = op.get_bind()
    if reconcile_development_drift_at_0024(bind, revision):
        _create_canonical_0023_analytics_tables()
        verify_development_0023_analytics_rebuild(bind)
