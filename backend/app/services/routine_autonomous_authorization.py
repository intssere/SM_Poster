...
def autonomous_content_policy(db, draft_id: str) -> dict:
    ...
    if existing_machine is not None:
        ...
        expected_payload = {
            ...
            "alt_text": source.alt_text if source else None,
            "destination_url": source.destination_url if source else None,
            "utm_url": source.utm_url if source else None,
            ...
            "creative_rendered_url": creative.rendered_url if creative else None,
            "creative_width": creative.width if creative else None,
            "creative_height": creative.height if creative else None,
